...
class PDFController extends Controller
{
    public function show(Client $client, Audit $audit)
    {
        ...
        $questions = [
            ...
            [
                'question' => 'It specified in the authority to proceed that a copy of the disclosure statement was given to you and your insurance planner and or plan/copy of your LAT was e-mailed to email address John@eliteinsure..co.nz . Did you receive them?',
